...
fn main() {
    ...
    let part_1 = explore_valves(&cave, starting_state, starting_status);

    println!("part 1: {:?}", part_1);
}

fn explore_valves(cave: &HashMap<String, (u64, Vec<String>)>, starting_state: ExplorationState, starting_status: Status) -> u64 {
